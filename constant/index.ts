...
export const VERIFY_MESSAGE_ADMIN = "Akun Anda telah berhasil diverifikasi. Berikut adalah Password Anda</br>Password : [[PASSWORD]]. </br>Jangan berikan password Anda kepada siapapun termasuk pihak BCF. BCF tidak akan pernah meminta kode OTP dan password Anda.</br></br>Terima kasih,</br>BCF"
