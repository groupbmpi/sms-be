...
export const beritaData : Omit<Berita, 'id'|'createdAt'|'updatedAt'>[] = [
    {
        judul: "Menkes: Setiap 20 Menit 1 Orang Meninggal Karena TBC",
        detail: `Jakarta (2/10) – Ikatan Alumni Bakrie Center Foundation yang tergabung dalam Home of Leaders, kembali menyelenggarakan The SDGs National Seminar Series: Sinergi Nasional dalam Katalisasi Pencapaian SDGs 2030 Menuju Indonesia Sehat, Berdaya, dan Lestari. Tahun ini merupakan tahun kedua pelaksanaan The SDGs National Seminar Series yang akan membahas topik-topik yang erat kaitannya dengan tujuan Pembangunan berkelanjutan, yakni Sinergi Multisektor dalam Upaya Mewujudkan Implementasi Kebijakan TBC, From Pollution to Solution: Mendorong Komitmen Multisektor Menuju Indonesia Bebas Polusi Plastik, Optimalisasi Standar Pelayanan Minimal Pendidikan (SPM) dalam Menjamin Pendidikan yang Setara dan Berkualitas, Kebijakan dan Rencana Aksi Energi Surya sebagai Wujud Komitmen Implementasi Energi Baru Terbarukan, serta Special Stage bertajuk Inovasi bagi Polusi, Upaya Sinergis dalam Persoalan Polusi Udara. Rangkaian seminar nasional ini akan berlangsung hingga 5 Oktober 2023, berlokasi di Horison Rasuna Jakarta.
        ...
        Hari pertama pelaksanaan seminar membahas mengenai sinergi multisektor dalam upaya mewujukan implementasi kebijakan TBC. Topik ini merupakan isu utama yang akan dibahas secara menyeluruh dalam rangkaian seminar hari pertama. Pada tahun 2022 Indonesia merupakan negara kedua dengan kasus TBC tertinggi di dunia, setelah India. Terdapat 969 ribu kasus TBC di Indonesia, dan sekitar 73 persen diantaranya menyerang masyarakat usia produktif.
    ...
    {
        judul: "Merajut Asa Anak Jalanan Melalui Pendidikan dan Pemberdayaan Berbasis Lingkungan",
    ...
    {
        judul: "Gerakan Lanjut Kuliah: Memutus Mata Rantai Kemiskinan dengan Pendidikan",
        detail: "Ini detail berita 3",
        linkPhoto: `Tahun 2018, Badan Pusat Statistik (BPS) mengungkap bahwa terdapat ketimpangan pendidikan dalam hal capaian rata-rata lama sekolah. Menurut data, kelompok termiskin hanya mampu menyelesaikan sekolah rata-rata selama 6,6 tahun atau setara dengan jenjang Sekolah Dasar. Adapun untuk kelompok ekonomi teratas, rata-rata lama sekolahnya dapat mencapai 11 tahun atau hanya setara 1 SMA. Hanya segelintir yang memiliki kesempatan dan akses untuk melanjutkan pendidikan ke jenjang yang lebih tinggi.
    ...
    {
        judul: "BCF Buka Opening Ceremony LEAD Indonesia 2022, 23 Organisasi Lintas Kegiatan Ikut Serta",
    ...
    {
        judul: "BCF BUKA KOMPETISI ESSAY, INFOGRAFIS, DAN TIKTOK DALAM MENDUKUNG PERCEPATAN PENCAPAIAN SDGS 2030",
        detail: `
        ...
        Ragam kompetisi yang terbuka untuk umum ini ditujukan sebagai pengingat kita Bersama bahwa target Sustainable Development Goals (SDGs) di tahun 2030 mendatang sudah semakin dekat. Kita semua punya peran untuk mewujudkan pendidikan yang merata, lingkungan yang asri dan bersih, kesetaraan gender, pertumbuhan ekonomi, serta kualitas dan infrastruktur kesehatan yang memadai bagi semua pihak.
        
        Kompetisi ini gratis dan terbuka hingga 15 Oktober 2022. Berikut syarat dan ketentuannya.
        
        Kompetisi Menulis Essay
        
        Tema
        
        1.Percepatan Eliminasi TBC di Indonesia pada Tahun 2030
        
        2.Peran dan Inovasi dalam Pengelolaan Sampah Plastik
        
        3.Solusi dalam Memutus Rantai Putus Sekolah (Sekolah Dasar, Menengah, Atas, dan Tinggi)
        
        4.Energi Terbarukan dalam Rangka Menuju Indonesia Bebas Polusi Udara
        
        Syarat & Ketentuan Kompetisi:
        
        – Peserta merupakan mahasiswa S1/S2 (dibuktikan dengan KTM), dan atau Perwakilan Komunitas/Lembaga Sosial terkait dengan Isu yang diangkat.
        
        – Usia Peserta 17 – 30 tahun.
        
        – Lomba bersifat individu
        
        – Peserta memilih salah satu dari sub topik yang telah ditentukan dengan mencantumkannya di dalam karya tulis
        
        – Peserta boleh mengirimkan maksimal 2 (dua) karya tulis dengan sub topik yang
        
        berbeda.
        
        – Naskah esai yang dikirim merupakan karya asli (bukan plagiasi) yang belum pernah menjadi juara pada lomba sejenis dan tidak sedang di ikutkan dalam lomba lain
        
        – Tulisan tidak boleh mengandung unsur SARA dan Pornografi
        
        – Keputusan dewan juri bersifat final dan tidak dapat diganggu gugat
        
        – Panitia memiliki hak untuk mempublikasikan naskah esai dengan tetap mencantumkan
        
        nama penulisnya
        
        – Kirimkan karyamu paling lambat 15 Oktober 2022 pukul 23.59 WIB dengan
        
        mengunggahnya dalam link berikut https://bit.ly/EssaySehatBerdayaLestari
        ...
        Syarat & Ketentuan Kompetisi Infografis:
        
        – Peserta merupakan WNI (Warga Negara Indonesia) dan berada di area Indonesia
        
        – Usia peserta 17 – 30 tahun
        
        – Peserta boleh mengirimkan lebih dari satu infografis (baik dalam tema yang sama maupun berbeda tema – maksimal 2 desain infografis untuk satu tema)
        
        – Infografis yang dikirimkan berbentuk PNG/JPG dengan ukuran A3 (29,7 cm x 42 cm)
        
        – Desain infografis tidak boleh mengandung unsur SARA dan pornografi
        
        – Dilarang keras menjiplak karya milik individu atau lembaga lain
        
        – Dalam desain infografis, menyematkan tagar #SehatBerdayaLestari
        
        – Keputusan dewan juri bersifat final dan tidak dapat diganggu gugat
        
        – Panitia memiliki hak untuk mempublikasikan desain infografis dengan tetap mencantumkan nama penulisnya
        
        – Kirimkan karyamu paling lambat 15 Oktober 2022 pukul 23.59 WIB dengan
        
        mengunggahnya dalam link berikut https://bit.ly/InfografisSehatBerdayaLestari
        
        TikTok Challenge (Video Edukatif Kreatif)
        
        Kategori:
        
        1.Video kreatif dan edukatif tentang mempercepat eliminasi TBC di Indonesia
        
        2.Video kreatif dan edukatif tentang pengelolaan sampah plastik
        
        3.Video kreatif dan edukatif tentang memutus rantai putus sekolah
        
        4.Video kreatif dan edukatif tentang energi terbarukan untuk bebas dari polusi udara.
        
        Syarat Peserta:
        
        – Masyarakat umum yang memiliki akun Tiktok (Wajib memiliki akun Tiktok sendiri)
        
        – WNI dan berusia 17-35 tahun
        
        – Peserta boleh bersifat perseorangan maupun berkelompok (group)
        
        – Satu akun hanya boleh memilih 1 tema video untuk diikutsertakan dalam Tiktok Challenge
        
        – Bersedia videonya dipublikasikan oleh BCF melalui kanal media sosial milik BCF
        
        Ketentuan TikTok Challenge:
        
        – Pilih 1 dari 4 tema yang disediakan oleh penyelenggara
        
        – Buat video kreatif dan edukatif sesuai dengan tema yang dipilih Video berdurasi minimal 30 detik dan maksimal 60 detik
        
        – Video tidak boleh mengandung unsur SARA dan pornografi
        
        – Format video disarankan potrait/vertikal
        
        – Follow akun resmi tiktok @sehatberdayalestari
        
        – Upload video kreatif dan edukatif kamu selambat-lambatnya 20 Oktober 2022 dan wajib
        
        tag akun @sehatberdayalestari dan tag 3 akun temanmu untuk mengikuti Tiktok Challenge ini.
        
        – Buat caption semenarik mungkin dan sematkan tagar #SehatBerdayaLestari #BakrieUntukNegeri #TiktokChallengeBakrie
        
        – Peserta yang sudah upload video dalam akun Tiktok masing-masing, juga wajib mengisi
        
        formulir pendaftaran berikut ini: https://bit.ly/TikTokSehatBerdayaLestari
        
        – BCF berhak mempublikasikan karya video peserta melalui platform media sosial BCF dengan tetap mencantumkan identitas content creator
        
        – Karya harus orisinil (bukan menjiplak) dan belum pernah diikutsertakan dalam lomba lain sebelumnya.
        
        Mari ikut serta dalam meningkatkan kesadaran publik untuk mewujudkan Sustainable
        
        Development Goals 2030 mendatang! Ditunggu karya-karya terbaik hingga 15 Oktober 2022.
    ...
    {
        judul: "Wakil Bupati Lombok Tengah Sambut Kehadiran Peserta Magang Bakrie Center Foundation",
        detail: `
    ...
    {
        judul: "Bakrie Center Foundation (BCF) Berkolaborasi Dengan Global Health Security Consortium dan B20",
        detail: `Kunjungan Anindya Bakrie bersama Delegasi Kadin Indonesia ke Inggris Raya pada bulan Oktober 2021 lalu
    ...
    {
        judul: "Donasi Sebesar Rp 466 Juta Terkumpul Dari Program LEAD Indonesia 2022",
        detail: `
        ...
        Dalam closing ceremony tersebut, Imbang Jaya Mangkuto menyatakan rasa kebanggannya terhadap kedua puluh satu peserta LEAD Indonesia 2022 yang telah menjalankan rangkaian kegiatan LEAD Indonesia 2022.
        
        “Semoga kehadiran LEAD Indonesia tidak hanya sebatas pertemuan transaksional melainkan dapat turut membangun SDM yang unggul dalam mengembangkan para aktivis sosial sehingga dapat berkontribusi dalam menuntaskan permasalahan sosial dan lingkungan di Indonesia. Selamat kepada pesrta, teruslah mengepakkan sayap untuk menjangkau dampak yang lebih besar dan luas bagi masyarakat Indonesia,” ungkap CEO BCF, Imbang Jaya Mangkuto.
        
        Para peserta LEAD Indonesia 2022 sebelumnya sudah mengikuti peningkatan kapasitas melalui kegiatan workshop dalam sesi Impact Forumselama 5 hari. Setelah itu mereka melanjutkan program dengan melakukan penggalangan dana baik secara daring maupun luring. Secara daring penggalangan dana dilakukan melalui platform crowdfunding bakriemanah.id. Sedangkan secara luring para peserta menjalin kerja sama baik dengan pemerintah, perusahaan, maupun instansi lainnya untuk mendapatkan donasi. Donasi yang terkumpul selama 3 bulan program berjalan sebesar Rp 466 Juta dengan melibatkan 542 donatur baik secara daring maupun luring.
        
        “Peserta LEAD Indonesia tidak hanya melakukan penggalangan dana untuk menjalankan proyek sosialnya, namun juga tengah menjalin kolaborasi dan kerja sama dengan 286 instansi baik dengan pemerintah maupun pihak swasta, serta instansi-instansi lainnya. Cakupan wilayah dari para peserta LEAD Indonesia tahun ini tersebar di 69 Kabupaten/Kota di Indonesia,” jelas Syahputrie Ramadhani, Program Domestik BCF.
        
        Selain memaparkan progress para peserta LEAD Indonesia 2022, dalam acara ini BCF juga turut mengumumkan tiga peserta terbaik. Ketiga peserta terbaik tersebut adalah Fitra Riyanto dari Alang Insitute (Cluster Gerakan Lanjut Kuliah), Muhamad Aswad Ashan dari Sobat Bumi Indonesia (Cluster Program Kampung Iklim), dan Muhamad Arif Pramarta dari Rumah Visioner (Cluster Pendidikan Anak Prasejahtera). Ketiganya akan mendapatkan dana apresiasi untuk pengembangan lembaga dan program dari BCF masing-masing sebesar Rp 5 Juta.
        
        “Dengan mengikuti program BCF ini kita punya ekosistem yang suportif sehingga kami mampu untuk menciptakan talent  pool. Kami jadi punya media untuk sharing dan sebagainya,” ungkap Fitra Riyanto dari Alang Institute.
        
        Selain mendapatkan dana apresiasi, ketiga peserta terbaik juga berkesempatan melakukan presentasi proyek sosialnya yang ditanggapi oleh GPA Manager PT Energi Mega Persada Tbk, Amru Mahali.
    ...
    {
        judul: "200 TB Rangers Siap Menjalankan Magang Campus Leaders Program Batch 7 untuk Menekan Kasus TBC di 6 Provinsi",
        detail: `JAKARTA (7/8) – 200 mahasiswa/i terbaik yang berhasil lulus seleksi magang Campus Leaders Program Batch 7 mengikuti pembukaan magang (onboarding) pasa Senin (7/8) secara daring. 200 mahasiswa yang disebut sebagai TB Ranger ini akan melakukan magang selama 1 semester bersama para lembaga mitra pemerhati TBC di 6 provinsi, yakni Sumatera Utara, Lampung, Jawa Barat, Jawa Tengah, Jawa Timur, dan Sulawesi Selatan. Magang Campus Leaders Program Batch 7 merupakan salah satu implementasi dari Program Kolaborasi Nasional Multi Stakeholder dan Multi-years Percepatan Eliminasi TBC di Indonesia Sebelum Tahun 2030.

        Seperti yang diketahui bersama, bahwa TBC di Indonesia masih menjadi penyakit paling mematikan setelah Covid-19. Menurut Global TB Report tahun 2022, Indonesia merupakan negara kedua di dunia yang memiliki kasus TBC tertinggi di dunia, setelah India. Diperkirakan ada 969 ribu kasus TBC di Indonesia pada tahun 2021. Program Kolaborasi Nasional Multistakeholder dan Multi-years Percepatan Eliminasi TBC di Indonesia Sebelum Tahun 2030 mengusung kemitraan hexa helix stakeholder approach. Kolaborasi ini menjadi jembatan antara pemerintah, akademisi, komunitas/masyarakat, dunia usaha, dan media massa untuk sama-sama mendukung percepatan eliminasi TBC di Indonesia.
        
        Pembukaan magang ini dihadiri oleh Deputi Bidang Koordinasi Peningkatan Kualitas Kesehatan & Pembangunan Kependudukan Kementerian Koordinator Bidang Pembangunan Manusia dan Kebudayaan RI, Direktur Pencegahan & Pengendalian Penyakit Menular Kementerian Kesehatan RI, Kepala Program Magang dan Studi Independen Bersertifikat Kemendikbur Ristek RI, Direktur Sinkronisasi Urusan Pemerintah Daerah III Kementerian Dalam Negeri RI, Wakil Ketua Umum Bidang Kesehatan Kamar Dagang dan Industri Indonesia, Wakil Ketua Umum Bidang Pendidikan dan Kebudayaan Kamar Dagang dan Industri Indonesia, Chairman & Founder Bakrie Center Foundation, dan CEO Bakrie Center Foundation.
        Imran Pambudi, Direktur Pencegahan & Pengendalian Penyakit Menular Kemenkes RI
        
        Selain itu, hadir pula perwakilan lembaga mitra yang berperan sebagai mentor bagi para peserta magang, yaitu Yayasan Mentari Meraki Asa Sumatera Utara, Inisiatif Lampung Sehat, SR Konsorsium Penabulu Jawa Barat, Mentari Sehat Indonesia Jawa Tengah, Yayasan Bhanu Yasa Sejahtera Jawa Timur, dan Yayasan Masyarakat Peduli TBC Sulawesi Selatan. Keenam lembaga tersebut merupakan alumni BCF masuk ke dalam wadah Ikatan Alumni BCF Home of Leaders. Dalam program magang ini, para mahasiswa yang disebut sebagai TB Ranger akan turun langsung ke masyarakat untuk melakukan pembelajaran hingga penelitian untuk mendalami bagaimana mencegah dan menanggulangi TBC.
        
        “Salah satu tujuan Sustainable Development Goals (SDGs) yaitu mewujudkan kesehatan bagi seluruh masyarakat. TBC merupakan suatu ancaman yang  tidak hanya mengancam dari sisi kesehatan, namun juga dari sisi sosial ekonomi. Saya mengajak para mahasiswa, para penggerak perubahan, untuk bersama-sama berjuang mencegah TBC dengan cara memberikan informasi yang benar terkait TBC. Saya yakin dengan adanya para TB Ranger ini kita bersama-sama bisa menanggulangi TBC,” jelas Imran Pambudi, Direktur Pencegahan & Pengendalian Penyakit Menular Kemenkes RI dalam sambutannya.
        
        Sistem magang Campus Leaders Program telah diakui setara dengan program Magang dan Studi Independen Bersertifikat (MSIB). Perguruan tinggi dapat mengonversi hasil magang mahasiswa maksimal sebanyak 20 SKS (Satuan Kredit Semester). Hal tersebut ditegaskan oleh Wachyu Hari Haji, Kepala Program MSIB Kemendikbud Ristek RI.
        
        “Kami mengapresiasi Bakrie Center Foundation yang sudah menginisiasi magang untuk program kolaborasi percepatan eliminasi TBC. Program ini selaras dengan Merdeka Belajar Kampus Merdeka (MBKM). Program magang ini sangat baik untuk dilakukan karena mahasiswa akan langsung belajar bagaimana kehidupan sebenarnya dan bagaimana menjadi pembawa solusi bagi permasalahan yang mereka temui di masyarakat,” tutur Wachyu.
        
        Wakil Ketua Umum Bidang Pendidikan KADIN Indonesia, Heru Dewanto juga menyampaikan bahwa KADIN Indonesia mendukung kegiatan magang ini. Magang Campus Leaders Program 7 dinilai bisa mendorong partisipasi aktif generasi muda untuk menanggulangi TBC.
        
        “KADIN Indonesia mengapresiasi program magang dan kolaborasi ini. Kami berharap mahasiswa yang terlibat dapat menggali potensi diri serta memberikan kontribusi maksimal untuk masyarakat,” jelas Heru saat memberikan sambutan.
        Dr. Heru Dewanto, WKU Bidang Pendidikan KADIN Indonesia
        
        Para TB Ranger akan melakukan magang dimulai pada hari ini, 7 Agustus 2023 hingga Desember 2023. 200 TB Ranger yang terpilih sebagai peserta magang Campus Leaders Program 7 berasal dari berbagai perguruan tinggi. 12 diantaranya telah bekerja sama dengan BCF, yaitu Universitas Sumatera Utara, Universitas Muhammadiyah Sumut, Universitas Lampung, Universitas Padjajaran, Institut Teknologi Bandung, Universitas Diponegoro, Universitas Muhammadiyah Semarang, Universitas Airlangga, Universitas Negeri Malang, Universitas Hasanudin, dan STIK Tamalatea Makassar.
        
        “Kegiatan ini merupakan upaya kolaborasi nasional kita dalam mencapai percepatan eliminasi TBC dengan mengirim dukungan SDM mahasiswa serta dosen pembimbing untuk membantu mengembangkan dan memperkuat lembaga sosial dalam pencapaian target eliminasi TBC tingkat provinsi dan nasional,” jelas Anindya Bakrie, Founder & Chairman BCF.
    ...
    {
        judul: "Program Magang Campus Leaders Diakui Kemendikbud Ristek RI, Bisa Konversi SKS",
        detail: `
        Program magang Campus Leaders didukung oleh Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi Republik Indonesia dan setara dengan program magang merdeka.
        
        Peserta magang bisa mengonversi SKS sesuai ketentuan yang berlaku.
    ...
    {
        judul: "Energi Baru Terbarukan Meningkatkan Kemandirian dan Ekonomi Masyarakat Desa",
        detail: `
        ...
        Direktur Eksekutif Yayasan IBEKA, Bapak Sapto Nugroho
    ...
    {
        judul: "Workshop: Peran Caregiver Bagi Penderita TBC saat Pandemi",
        detail: `Sejauh mana peran caregiver dan relawan TBC dalam memproteksi pasien TBC dari paparan Covid-19?
    ...
    {
        judul: "Diskusi Online: Orang Tanpa Gejala: Tantangan Memutus Rantau Covid-19",
        detail: `Dalam upaya memahami dan mengatasi penyebaran COVID-19, orang tanpa gejala menjadi elemen krusial yang menantang. Identifikasi mereka yang tidak menunjukkan gejala penyakit menjadi tantangan utama dalam memutus rantai penularan. Diskusi online ini bertujuan untuk menyoroti peran orang tanpa gejala dalam penyebaran virus, menggali cara-cara deteksi dini yang lebih efektif, serta mengidentifikasi strategi untuk menghadapi tantangan ini.

        Peran orang tanpa gejala dalam penularan COVID-19 menjadi sorotan utama dalam diskusi ini. Meskipun mereka tidak menunjukkan gejala yang jelas, mereka dapat menjadi pembawa virus yang signifikan dalam komunitas, memperluas jangkauan penyebaran tanpa disadari. Oleh karena itu, pemahaman lebih dalam tentang bagaimana virus ini tersebar melalui individu tanpa gejala menjadi kunci dalam menghentikan gelombang infeksi yang tak terduga.
        
        Tantangan utama lainnya adalah dalam deteksi dini orang-orang tanpa gejala. Metode-metode deteksi yang sensitif dan spesifik perlu dikembangkan untuk mengidentifikasi individu yang tidak menunjukkan gejala namun tetap merupakan pembawa virus. Diskusi ini akan mengeksplorasi teknologi terbaru, penggunaan tes yang lebih efisien, dan strategi pendekatan kesehatan masyarakat yang lebih tepat guna untuk mengatasi tantangan ini.
    ...
    {
        judul: "Jalin Kolaborasi dengan Sociopreneur Indonesia Demi Mencapai SDG’s 2030",
        detail: `
        Kita semua pasti ingin berbuat sesuatu untuk menjadikan Indonesia lebih baik. Namun, kami sadar tidak semua permasalahan yang ada bisa dipecahkan sendiri. Kami membutuhkah lebih banyak otak untuk berpikir, lebih banyak tangan untuk bekerja, dan lebih banyak hati untuk empati. Kolaborasi merupakan pintu bagi kita semua, agar bisa membantu memecahkan persoalan yang ada di tengah masyarakat dan lingkungan. 
        
        Kemarin (29/01/2020), Bakrie Center Foundation diundang oleh Sociopreneur Indonesia (SID) untuk menghadiri New Year Gathering di Gedung BPPT, Jakarta Pusat. Partnership for The Goal menjadi tema yang dihighlight hari itu. Semua stakeholder yang hadir, sangat menyadari bahwa saat ini bukan saatnya untuk kompetisi namun kolaborasi. Dengan kolaborasi kita semua bisa membentuk responsible ecosystem. 
        
        Ada dua sesi panel yang dihadirkan dalam New Year Gathering tersebut. Sesi panel pertama diisi oleh para tim di balik layar Sociopreneuer Indonesia ; 4 orang anak muda yang masing-masing memegang peranan penting dalam berbagai program SociopreneurID. Sesi panel kedua menghadirkan stake holders yang saat ini sudah bekerja sama untuk mengembangkan program bersama SociopreneuerID, antara lain BI Institute dan Elex Media Komputindo.
