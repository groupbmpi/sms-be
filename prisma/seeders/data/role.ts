...
export const roleData : Omit<Role, 'id' | 'createdAt' | 'updatedAt'>[] = [
    ...
    {
        role: "User",
        akses: "user:;lembaga:read,update,write,delete;berita:read,write,update,delete;laporankegiatan:read,write,updateOwn,delete;laporanmasalah:read,write,update,delete"
    }
]